...
disp('SetNumberAccumulations--------------------------------------');
returnCode = SetNumberAccumulations(numberAccums);
returnCode
numberAccums


disp('SetNumberKinetics--------------------------------------');
returnCode = SetNumberKinetics(numberKins);
returnCode
numberKins
...
disp('GetNumberAmpl--------------------------------------');
[returnCode,numberamp]=GetNumberAmp;
returnCode
numberamp
...
disp('GetTotalNumberImagesAcquired--------------------------------------');

[returnCode,noimages]=GetTotalNumberImagesAcquired;
noimages


while(noimages ~= numberKins)
  disp('WaitforAcquisition--------------------------------------');
  returnCode= WaitforAcquisition;
  disp('GetTotalNumberImagesAcquired--------------------------------------');
  [returnCode,noimages]=GetTotalNumberImagesAcquired;
  noimages
...
data = zeros(numberKins*xpixels*ypixels,1);

disp('GetAcquiredData --------------------------------------');
[returnCode,data]=GetAcquiredData(xpixels*ypixels*numberKins);
