function [ret] = OA_SetFloat (name, param, value)
% [ret, value] = OA_SetFloat(name, param, value)
%
% Description	This function is used to set values for floating point type acquisition parameters 
...
[ret] = andorfunctions('OA_SetFloat', name, param, value);
